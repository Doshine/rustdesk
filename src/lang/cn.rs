...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("empty_recent_title", "还没有远程记录"),
        ("empty_recent_subtitle", "输入对方 ID，发起第一次连接"),
        ("empty_go_connect", "去连接"),
        ("empty_favorite_title", "暂无收藏设备"),
        ("empty_favorite_subtitle", "把常用设备加入收藏，下次一键直达"),
        ("empty_lan_title", "局域网暂未发现设备"),
        ("empty_lan_subtitle", "确保对方已启动蓝鲸银河并在同一网络"),
        ("empty_ab_login_title", "登录后使用地址簿"),
        ("empty_ab_login_subtitle", "跨设备同步你的常用联系人"),
        ("empty_go_login", "去登录"),
        ("empty_search_title", "没有找到匹配的设备"),
        ("empty_search_subtitle", "换个关键词试试"),
        ("empty_load_failed_tip", "加载失败，点击重试"),
        ("wizard_step1_title", "先把权限给足"),
        ("wizard_step1_detail", "别人要远程协助你，这台设备需要屏幕录制与无障碍权限。现在给好，会话中途就不会被系统弹窗打断。"),
        ("wizard_step1_action", "去「设备」页授权"),
        ("wizard_step2_title", "给这台设备起个名字"),
        ("wizard_step2_detail", "同事在设备列表里看到的是这个名字，而不是一串数字。写清楚是谁的、放在哪，找起来快得多。"),
        ("wizard_step2_placeholder", "例如：财务-王工 / 机房-跳板机"),
        ("wizard_step3_title", "把这个 ID 给对方"),
        ("wizard_step3_detail", "对方在他的客户端里输入这个 ID 就能发起连接。每次连接都要你这边确认，不确认连不进来。"),
        ("wizard_skip", "跳过"),
        ("wizard_back", "上一步"),
        ("wizard_next", "下一步"),
        ("wizard_done", "开始使用"),
        ...
        ("quality_path_unknown", "路径待定"),
        ("quality_semantics_prefix", "网络质量"),
        ("overlay_tab_monitors", "显示器"),
        ("overlay_tab_quality", "画质"),
        ("overlay_tab_permissions", "权限"),
        ("overlay_tab_files", "文件"),
        ("overlay_tab_chat", "聊天"),
        ("overlay_tab_diagnostics", "诊断"),
        ("overlay_monitors_empty_title", "还没拿到对方的显示器列表"),
        ("overlay_monitors_empty_detail", "对方可能刚锁屏或正在切换用户。"),
        ("overlay_quality_presets", "情景预设"),
        ("overlay_quality_loading", "正在读取当前画质设置"),
        ("overlay_quality_loading_hint", "正在向对方确认支持的编码…"),
        ("overlay_quality_error_title", "读不到画质设置"),
        ("overlay_quality_error_detail", "会话还在，重试一次通常就好。"),
        ("overlay_quality_footnote", "预设会立刻生效，随时可以换。换预设不会断开当前会话。"),
        ("quality_preset_office_title", "办公"),
        ("quality_preset_office_desc", "文字清晰优先"),
        ("quality_preset_media_title", "影音"),
        ("quality_preset_media_desc", "流畅优先"),
        ("quality_preset_design_title", "设计"),
        ("quality_preset_design_desc", "色彩准确优先"),
        ("quality_preset_weak_title", "弱网"),
        ("quality_preset_weak_desc", "保证不断线"),
        ("quality_preset_design_downgrade", "对方的编码不支持全色彩，已按可用的最高精度显示"),
        ("overlay_permissions_loading", "正在确认对方授予的权限"),
        ("overlay_permissions_granted_by_peer", "对方授予的权限"),
        ("overlay_permissions_denied_hint", "标为「未授予」的能力由对方决定，本端打不开。需要的话请联系对方在被控端放开。"),
        ("overlay_perm_keyboard", "键鼠控制"),
        ("overlay_perm_clipboard", "剪贴板"),
        ("overlay_perm_audio", "音频"),
        ("overlay_perm_file", "文件传输"),
        ("overlay_perm_restart", "远程重启"),
        ("overlay_perm_recording", "录制"),
        ("overlay_perm_granted", "已授予"),
        ("overlay_perm_denied", "未授予"),
        ("overlay_files_loading", "正在准备文件通道"),
        ("overlay_files_title", "把文件拖进画面即可发送"),
        ("overlay_files_detail", "也可以打开完整的文件传输窗口，双向浏览并传输。"),
        ("overlay_files_denied_title", "对方没有开放文件传输"),
        ("overlay_files_denied_detail", "这项由被控端决定，本端改不了。"),
        ("overlay_action_open_permissions", "查看权限清单"),
        ("overlay_copy_diagnostics", "复制诊断信息"),
        ("hud_explain_fair_relay", "画面稍有延迟：当前走中继，不是直连"),
        ("hud_explain_fair_direct", "画面稍有延迟：到对方的网络往返变慢了"),
        ("hud_explain_poor", "画面明显卡顿：网络往返超过 120 毫秒，可改用「弱网」预设"),
        ("hud_explain_offline", "已经 90 秒没有收到对方的数据"),
        ("drop_files_denied", "对方没有开放文件传输，文件没有发送"),
        ("drop_files_fallback", "拿不到对方的目录，已打开文件传输窗口，请在那里选择位置"),
        ("drop_files_sent", "已开始发送到"),
        ("Empty Username", "空用户名"),
        ("Empty Password", "空密码"),
        ("Me", "我"),
        ...
        ("keyboard_capture_tip", "全键透传（含 Esc）。退出全屏请用工具栏按钮或 Ctrl+Alt+F。"),
        ("Delay", "延迟"),
        ("Packet Loss", "丢包率"),
        ("Relay Node", "中继节点"),
        ("Direct", "直连"),
        ("Relayed", "中继"),
        ("Saved", "已保存"),
        ("restart_required_tip", "此项修改将在重启应用后生效。"),
        ("Restart Now", "立即重启"),
        ("restart_confirm_tip", "重启应用以使修改生效，现在重启吗？"),
        ("Show Password", "显示密码"),
        ("Hide Password", "隐藏密码"),
        ("ID", "ID"),
        ("Grid View", "网格视图"),
