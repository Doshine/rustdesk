...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("empty_recent_title", "No remote sessions yet"),
        ("empty_recent_subtitle", "Enter a partner ID and start your first connection."),
        ("empty_go_connect", "Connect now"),
        ("empty_favorite_title", "No favorite devices"),
        ("empty_favorite_subtitle", "Add frequently used devices to favorites for one-click access next time."),
        ("empty_lan_title", "No devices discovered on the LAN"),
        ("empty_lan_subtitle", "Make sure the partner is running and on the same network."),
        ("empty_ab_login_title", "Log in to use the address book"),
        ("empty_ab_login_subtitle", "Sync your frequent contacts across devices."),
        ("empty_go_login", "Log in now"),
        ...
        ("wizard_step1_title", "Grant the permissions first"),
        ("wizard_step1_detail", "To let someone assist you remotely, this device needs screen recording and accessibility permissions. Granting them now avoids a system prompt interrupting you mid-session."),
        ("wizard_step1_action", "Open the device page"),
        ("wizard_step2_title", "Name this device"),
        ("wizard_step2_detail", "This is the name colleagues see in the device list instead of a string of digits. Saying whose it is and where it sits makes it much easier to find."),
        ("wizard_step2_placeholder", "e.g. Finance-Wang / DC-jump-host"),
        ("wizard_step3_title", "Share this ID"),
        ("wizard_step3_detail", "They enter this ID in their client to start a session. Every connection needs your approval — without it nobody gets in."),
        ("wizard_skip", "Skip"),
        ("wizard_back", "Back"),
        ("wizard_next", "Next"),
        ...
        ("quality_path_unknown", "Path pending"),
        ("quality_semantics_prefix", "Network quality"),
        ("overlay_tab_monitors", "Monitors"),
        ("overlay_tab_quality", "Quality"),
        ("overlay_tab_permissions", "Permissions"),
        ("overlay_tab_files", "Files"),
        ("overlay_tab_chat", "Chat"),
        ("overlay_tab_diagnostics", "Diagnostics"),
        ("overlay_monitors_empty_title", "No monitors reported yet"),
        ("overlay_monitors_empty_detail", "The peer may be locked or switching users."),
        ("overlay_quality_presets", "Presets"),
        ("overlay_quality_loading", "Reading current quality settings"),
        ("overlay_quality_loading_hint", "Checking which codecs the peer supports…"),
        ("overlay_quality_error_title", "Cannot read quality settings"),
        ("overlay_quality_error_detail", "The session is still up; retrying usually works."),
        ("overlay_quality_footnote", "Presets apply immediately and can be switched at any time without dropping the session."),
        ("quality_preset_office_title", "Office"),
        ("quality_preset_office_desc", "Sharp text first"),
        ("quality_preset_media_title", "Media"),
        ("quality_preset_media_desc", "Smoothness first"),
        ("quality_preset_design_title", "Design"),
        ("quality_preset_design_desc", "Color accuracy first"),
        ("quality_preset_weak_title", "Weak network"),
        ("quality_preset_weak_desc", "Stay connected"),
        ("quality_preset_design_downgrade", "The peer's codec cannot do full color; showing the highest available precision instead"),
        ("overlay_permissions_loading", "Checking what the peer granted"),
        ("overlay_permissions_granted_by_peer", "Granted by peer"),
        ("overlay_permissions_denied_hint", "Items marked as not granted are controlled by the peer and cannot be enabled from this side."),
        ("overlay_perm_keyboard", "Keyboard & mouse"),
        ("overlay_perm_clipboard", "Clipboard"),
        ("overlay_perm_audio", "Audio"),
        ("overlay_perm_file", "File transfer"),
        ("overlay_perm_restart", "Remote restart"),
        ("overlay_perm_recording", "Recording"),
        ("overlay_perm_granted", "Granted"),
        ("overlay_perm_denied", "Not granted"),
        ("overlay_files_loading", "Preparing the file channel"),
        ("overlay_files_title", "Drop files onto the screen to send"),
        ("overlay_files_detail", "Or open the full file transfer window to browse and transfer both ways."),
        ("overlay_files_denied_title", "File transfer is not allowed by the peer"),
        ("overlay_files_denied_detail", "This is decided by the peer and cannot be changed here."),
        ("overlay_action_open_permissions", "See what was granted"),
        ("overlay_copy_diagnostics", "Copy diagnostics"),
        ("hud_explain_fair_relay", "Slight lag: the connection is going through a relay, not direct"),
        ("hud_explain_fair_direct", "Slight lag: the round trip to the peer got slower"),
        ("hud_explain_poor", "Noticeable lag: round trip is over 120 ms. Try the weak-network preset."),
        ("hud_explain_offline", "No data from the peer for 90 seconds"),
        ("drop_files_denied", "The peer does not allow file transfer; nothing was sent"),
        ("drop_files_fallback", "Could not read the peer's folders; opened the file transfer window instead"),
        ("drop_files_sent", "Sending to"),
        ...
        ("keyboard_capture_tip", "All keys (incl. Esc) are sent to the remote side. Exit fullscreen via the toolbar button or Ctrl+Alt+F."),
        ("Delay", "Delay"),
        ...
        ("Relayed", "Relayed"),
        ("Saved", "Saved"),
        ("restart_required_tip", "This change takes effect after restarting the application."),
        ("Restart Now", "Restart now"),
        ("restart_confirm_tip", "Restart the application now to apply the change?"),
