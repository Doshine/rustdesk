...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("empty_recent_title", "還沒有遠端連線記錄"),
        ("empty_recent_subtitle", "輸入對方 ID，發起第一次連線"),
        ("empty_go_connect", "去連線"),
        ("empty_favorite_title", "暫無收藏設備"),
        ("empty_favorite_subtitle", "把常用設備加入收藏，下次一鍵直達"),
        ("empty_lan_title", "區域網路暫未發現設備"),
        ("empty_lan_subtitle", "確保對方已啟動藍鯨銀河並在同一網路"),
        ("empty_ab_login_title", "登入後使用通訊錄"),
        ("empty_ab_login_subtitle", "跨裝置同步你的常用聯絡人"),
        ("empty_go_login", "去登入"),
        ("empty_search_title", "沒有找到匹配的設備"),
        ("empty_search_subtitle", "換個關鍵詞試試"),
        ("empty_load_failed_tip", "載入失敗，點擊重試"),
